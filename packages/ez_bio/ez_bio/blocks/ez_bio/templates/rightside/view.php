...
<div class="ezbio-wrap">
	<div class="row">
		<?php   if(isset($img) && is_object($img)){?><div class="col-xs-12 ezb-xxs-only"><img src="<?php   echo $img->getURL() ?>" class="biopic" /></div><?php   } ?>
		<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
			<div class="row">
				<?php   if(isset($img) && is_object($img)){?><div class="col-xs-3 hidden-md hidden-lg ezb-xxs"><img src="<?php   echo $img->getURL() ?>" class="biopic" /></div><?php   } ?>
				<div class="col-xs-9">
					...
					<div class="bio-social hidden-sm hidden-md hidden-lg" style="text-align: left;"><hr />
			...
			<div class="biocard">
				...
				<div class="bio-social hidden-xs hidden-md hidden-lg"><hr />
					<?php   if(isset($facebook)&&$facebook!=""){?><a href="http://www.facebook.com/<?php   echo $facebook ?>" target="_blank"><i class="fa fa-facebook fa-lg"></i></a><?php   } ?>
					<?php   if(isset($twitter)&&$twitter!=""){?><a href="http://www.twitter.com/<?php   echo $twitter ?>" target="_blank"><i class="fa fa-twitter fa-lg"></i></a><?php   } ?>
					<?php   if(isset($linkedin)&&$linkedin!=""){?><a href="http://www.linkedin.com/<?php   echo $linkedin ?>" target="_blank"><i class="fa fa-linkedin fa-lg"></i></a><?php   } ?>
					<?php   if(isset($instagram)&&$instagram!=""){?><a href="http://www.instagram.com/<?php   echo $instagram ?>" target="_blank"><i class="fa fa-instagram fa-lg"></i></a><?php   } ?>
		...
		<div class="col-sm-3 col-md-3 col-lg-3 hidden-xs hidden-sm">
			<?php   if(isset($img) && is_object($img)){?><img src="<?php   echo $img->getURL() ?>" class="biopic" /><?php   } ?>
			<div class="bio-social hidden-xs hidden-sm">
				<?php   if(isset($facebook)&&$facebook!=""){?><a href="http://www.facebook.com/<?php   echo $facebook ?>" target="_blank"><i class="fa fa-facebook fa-lg"></i></a><?php   } ?>
				<?php   if(isset($twitter)&&$twitter!=""){?><a href="http://www.twitter.com/<?php   echo $twitter ?>" target="_blank"><i class="fa fa-twitter fa-lg"></i></a><?php   } ?>
				<?php   if(isset($linkedin)&&$linkedin!=""){?><a href="http://www.linkedin.com/<?php   echo $linkedin ?>" target="_blank"><i class="fa fa-linkedin fa-lg"></i></a><?php   } ?>
				<?php   if(isset($instagram)&&$instagram!=""){?><a href="http://www.instagram.com/<?php   echo $instagram ?>" target="_blank"><i class="fa fa-instagram fa-lg"></i></a><?php   } ?>
