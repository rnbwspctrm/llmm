...
--
-- Dumping data for table `btvividthumbgallerythumb`
--

LOCK TABLES `btvividthumbgallerythumb` WRITE;
/*!40000 ALTER TABLE `btvividthumbgallerythumb` DISABLE KEYS */;
/*!40000 ALTER TABLE `btvividthumbgallerythumb` ENABLE KEYS */;
UNLOCK TABLES;
